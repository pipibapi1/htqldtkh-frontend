            ...
            */}
            ...
            <div className='col-start-9 col-span-2 flex items-center'>
                <Link to={`/${appRouters.LINK_TO_REGISTER_PAGE}`}>
                    <div className="text-[#0079CC] font-semibold py-2 px-5 no-underline hover:underline hover:cursor-pointer">
                    Đăng ký tài khoản?
                    </div>
                </Link>
                <Link to={`/${appRouters.LINK_TO_LOGIN_PAGE}`}>
                    <div className="bg-[#0079CC] transition text-white font-semibold py-4 px-5 border border-white-500 rounded-[15px] hover:bg-[#025A97] hover:cursor-pointer">
                    ĐĂNG NHẬP
                    </div>
                </Link>
            </div>)}
