        ...
        <div className='flex flex-col w-100 mb-6'>
            ...
            <div className='flex flex-col ml-2'>
                ...
                <div className='flex flex-col justify-between my-1'>
                    ...
                    <select
                        className="bg-white w-full h-10 border border-black border-1 rounded-lg focus:ring-blue-500 px-2 w-40"
                        name="gender"
                ...
                <div className='flex flex-col justify-between my-1'>
                    ...
                    <div className='relative w-40'>
                        <DatePicker
                            ...
                            showYearDropdown
                            dropdownMode="select"
                            className="w-full h-10 border border-black border-1 rounded-lg px-2 w-40"
                        />
                ...
                <div className='flex flex-col justify-between my-1'>
                    ...
                    <select
                        className="bg-white w-full h-10 border border-black border-1 rounded-lg focus:ring-blue-500 px-2 w-96"
