...
describe("vice dean account page management", () => {
    describe('Modal component', () => {
        ...
        test('should show warning toast when username or password is empty', () => {
          ...
          expect(screen.getByText('Bạn có chắc muốn cập nhật tài khoản phó chủ nhiệm này?')).toBeInTheDocument();
        });
    });
    ...
    describe("OtherMemberRow", () => {
        ...
        test("should show the confirmation modal when 'Xóa' is clicked", () => {
          ...
          expect(component.getByText("Bạn có chắc muốn xóa tài khoản phó chủ nhiệm này?")).toBeInTheDocument();
    ...
    describe("reder vice dean acount page correct ly", () => {
        ...
        expect(screen.getByText('Danh sách tài khoản phó chủ nhiệm:')).toBeInTheDocument();
    })
})