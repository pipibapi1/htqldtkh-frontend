...
const getRequestListService = (queryData: RequestQuery) => {
    ...
    return axios.get(REQUEST_API_URL + queryString, { headers: authHeader() })
        .then((response) => {
...
const putUpdateARequestService = (updateInfo: any) => {
    ...
    return axios.put(REQUEST_API_URL + "/" + _id, {request: request}, { headers: authHeader() })
        .then((response) => {
            return response.data
        })
}
...
const postAddARequestService = (newRequest: any) => {
    ...
    return axios.post(REQUEST_API_URL, {request: request}, { headers: authHeader() })
        .then((response) => {
            return response.data
        })
}
...
const deleteRemoveARequestService = (_id: string) => {
    return axios.delete(REQUEST_API_URL + "/" + _id, { headers: authHeader() })
        .then((response) => {
            return response.data
        })
}
...
const putApproveARequestService = (_id: string) => {
    return axios.put(REQUEST_API_URL + "/" + _id + "/" + "approve",{}, { headers: authHeader() })
        .then((response) => {
            return response.data
        })
}
