...
const getFvdListService = (queryData: FvdQuery) => {
    ...
    return axios.get(FVD_API_URL + queryString, { headers: authHeader() })
        .then((response) => {
...
const addAFvdService = (info: any) => {
    return axios.post(FVD_API_URL, info, { headers: authHeader() })
        .then((response) => {
            return response.data
        })
}
...
const updateFvdPersonalInfoService = (newInfoData: any) => {
    ...
    return axios.put(FVD_API_URL + '/' + _id, newInfo, { headers: authHeader() })
        .then((response) => {
            return response.data
        })
}
...
const deleteAFvdService = (_id: string) => {
    return axios.delete(FVD_API_URL + '/' + _id, { headers: authHeader() })
        .then((response) => {
            return response.data
        })
}
